    ...
    return (
        <div>
            ...
            <div className="row">
                <div className="col-8 main-module justify-content-center">
                    <p className="pt-4 pb-2 px-2 main-module-text">
                        To view source code, instructions for running this app on your own server, and videos presenting the app in use, visit our public Github page 
                    </p>
                    <div className="pb-4">
                        <a href="https://github.com/NoahZielke/Subtitle-Generator-cs495"  target="_blank" className="btn btn-primary">
